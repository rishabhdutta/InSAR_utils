...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 10 10:00:41 2020
...
##############################################################################       
# plot the addt for the year 2020 
...
for i in range(8):
    ...
    for j in range(locnum):
        ...
        temp2020[j, ind_days] = var_2Tmat[:, indlat1, indlon1].flatten(order='F')
        
    prevdays = prevdays + numdays

var_name = 'temp2020.mat'
sio.savemat(var_name, {'temp2020':temp2020})
f.close()
...
for i in range(locnum): 
    ...
    addt_prev = 0
    for days in range(num_zeroday):
        if temp2020[i, first_day -1 + days] > 273.15:
            addt_day = temp2020[i, first_day-1+days] - 273.15
        else:
            addt_day = 0 
            
        addt2020[i, days] = addt_prev + addt_day
        addt_prev = addt_prev + addt_day
...
var_name = 'addt2020.mat'
sio.savemat(var_name, {'addt2020':addt2020, 'details_addt':details_addt, \
                       'lonlat':locall})             
